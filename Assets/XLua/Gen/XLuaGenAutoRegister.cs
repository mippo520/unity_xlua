...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(GameScene), GameSceneWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Launcher), LauncherWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MainScene), MainSceneWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(NewPrefab), NewPrefabWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Resource.ResourcesCount), AssetsCommonResourceResourcesCountWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Resource.ResourcesManager), AssetsCommonResourceResourcesManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Net.NetManager), AssetsCommonNetNetManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Net.FirstPackageCreator), AssetsCommonNetFirstPackageCreatorWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Net.NormalPackageCreator), AssetsCommonNetNormalPackageCreatorWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Net.IPackageCreator), AssetsCommonNetIPackageCreatorWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Lua.LuaBehaviour), AssetsCommonLuaLuaBehaviourWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Assets.Common.Log.Info), AssetsCommonLogInfoWrap.__Register);
