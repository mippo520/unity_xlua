...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp18(Assets.Common.Net.NetState p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(byte[] p0, Assets.Common.Net.NetState p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<Assets.Common.Net.NetState>))
			{
			    return new System.Action<Assets.Common.Net.NetState>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<byte[], Assets.Common.Net.NetState>))
			{
			    return new System.Action<byte[], Assets.Common.Net.NetState>(__Gen_Delegate_Imp19);
			}
