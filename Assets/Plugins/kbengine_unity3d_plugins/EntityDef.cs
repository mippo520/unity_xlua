...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			ScriptModule pHelloEntityModule = new ScriptModule("HelloEntity");
			EntityDef.moduledefs["HelloEntity"] = pHelloEntityModule;
			EntityDef.idmoduledefs[2] = pHelloEntityModule;

			Property pHelloEntity_position = new Property();
			pHelloEntity_position.name = "position";
			pHelloEntity_position.properUtype = 40000;
			pHelloEntity_position.properFlags = 4;
			pHelloEntity_position.aliasID = 1;
			Vector3 HelloEntity_position_defval = new Vector3();
			pHelloEntity_position.defaultVal = HelloEntity_position_defval;
			pHelloEntityModule.propertys["position"] = pHelloEntity_position; 

			pHelloEntityModule.usePropertyDescrAlias = true;
			pHelloEntityModule.idpropertys[(UInt16)pHelloEntity_position.aliasID] = pHelloEntity_position;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), property(position / 40000).");

			Property pHelloEntity_direction = new Property();
			pHelloEntity_direction.name = "direction";
			pHelloEntity_direction.properUtype = 40001;
			pHelloEntity_direction.properFlags = 4;
			pHelloEntity_direction.aliasID = 2;
			Vector3 HelloEntity_direction_defval = new Vector3();
			pHelloEntity_direction.defaultVal = HelloEntity_direction_defval;
			pHelloEntityModule.propertys["direction"] = pHelloEntity_direction; 

			pHelloEntityModule.usePropertyDescrAlias = true;
			pHelloEntityModule.idpropertys[(UInt16)pHelloEntity_direction.aliasID] = pHelloEntity_direction;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), property(direction / 40001).");

			Property pHelloEntity_spaceID = new Property();
			pHelloEntity_spaceID.name = "spaceID";
			pHelloEntity_spaceID.properUtype = 40002;
			pHelloEntity_spaceID.properFlags = 16;
			pHelloEntity_spaceID.aliasID = 3;
			UInt32 HelloEntity_spaceID_defval;
			UInt32.TryParse("", out HelloEntity_spaceID_defval);
			pHelloEntity_spaceID.defaultVal = HelloEntity_spaceID_defval;
			pHelloEntityModule.propertys["spaceID"] = pHelloEntity_spaceID; 

			pHelloEntityModule.usePropertyDescrAlias = true;
			pHelloEntityModule.idpropertys[(UInt16)pHelloEntity_spaceID.aliasID] = pHelloEntity_spaceID;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), property(spaceID / 40002).");

			List<DATATYPE_BASE> pHelloEntity_onEnter_args = new List<DATATYPE_BASE>();

			Method pHelloEntity_onEnter = new Method();
			pHelloEntity_onEnter.name = "onEnter";
			pHelloEntity_onEnter.methodUtype = 2;
			pHelloEntity_onEnter.aliasID = 1;
			pHelloEntity_onEnter.args = pHelloEntity_onEnter_args;

			pHelloEntityModule.methods["onEnter"] = pHelloEntity_onEnter; 
			pHelloEntityModule.useMethodDescrAlias = true;
			pHelloEntityModule.idmethods[(UInt16)pHelloEntity_onEnter.aliasID] = pHelloEntity_onEnter;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), method(onEnter / 2).");

			List<DATATYPE_BASE> pHelloEntity_onSay_args = new List<DATATYPE_BASE>();
			pHelloEntity_onSay_args.Add(EntityDef.id2datatypes[12]);

			Method pHelloEntity_onSay = new Method();
			pHelloEntity_onSay.name = "onSay";
			pHelloEntity_onSay.methodUtype = 3;
			pHelloEntity_onSay.aliasID = 2;
			pHelloEntity_onSay.args = pHelloEntity_onSay_args;

			pHelloEntityModule.methods["onSay"] = pHelloEntity_onSay; 
			pHelloEntityModule.useMethodDescrAlias = true;
			pHelloEntityModule.idmethods[(UInt16)pHelloEntity_onSay.aliasID] = pHelloEntity_onSay;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), method(onSay / 3).");

			List<DATATYPE_BASE> pHelloEntity_say_args = new List<DATATYPE_BASE>();
			pHelloEntity_say_args.Add(EntityDef.id2datatypes[12]);

			Method pHelloEntity_say = new Method();
			pHelloEntity_say.name = "say";
			pHelloEntity_say.methodUtype = 1;
			pHelloEntity_say.aliasID = -1;
			pHelloEntity_say.args = pHelloEntity_say_args;

			pHelloEntityModule.methods["say"] = pHelloEntity_say; 
			pHelloEntityModule.cell_methods["say"] = pHelloEntity_say;

			pHelloEntityModule.idcell_methods[pHelloEntity_say.methodUtype] = pHelloEntity_say;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(HelloEntity), method(say / 1).");
